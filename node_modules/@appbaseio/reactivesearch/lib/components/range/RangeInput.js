...
var RangeInput = function (_Component) {
	...
	function RangeInput(props) {
		...
		var value = props.selectedValue || props.value || props.defaultValue || props.range;
		_this.state = {
			start: value.start,
			end: value.end,
			isStartValid: true,
		...
		_this.startInputRef = _react2.default.createRef();
		_this.endInputRef = _react2.default.createRef();
		return _this;
	}
...
var _initialiseProps = function _initialiseProps() {
	...
	this.handleInputChange = function (e) {
		...
		}, _currentValue[name] = value, _currentValue);
	...
	this.handleSliderChange = function (_ref) {
		var start = _ref[0],
		    end = _ref[1];
	...
	this.handleSlider = function (_ref2) {
		...
		if (document.activeElement !== _this2.startInputRef.current && document.activeElement !== _this2.endInputRef.current) {
			_this2.setState({
				start: start,
				end: end
			});
