...
var ReactiveList = function (_Component) {
	...
	ReactiveList.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
		...
		if (this.props.onData) {
			(0, _helper.checkSomePropChange)(this.props, prevProps, ['hits', 'streamHits'], function () {
				_this2.props.onData(_this2.getAllData());
			});
		}
		if (!(0, _helper.isEqual)(this.props.sortOptions, prevProps.sortOptions) || this.props.sortBy !== prevProps.sortBy || this.props.size !== prevProps.size || !(0, _helper.isEqual)(this.props.dataField, prevProps.dataField) || !(0, _helper.isEqual)(this.props.includeFields, prevProps.includeFields) || !(0, _helper.isEqual)(this.props.excludeFields, prevProps.excludeFields)) {
			...
			if (this.props.sortOptions) {
				...
				options.sort = [(_ref4 = {}, _ref4[this.props.sortOptions[0].dataField] = {
					order: this.props.sortOptions[0].sortBy
				}, _ref4)];
			} else if (this.props.sortBy) {
				var _ref5;
		...
		if (!this.props.pagination) {
			if (this.props.hits && prevProps.hits) {
				if (this.props.hits.length !== prevProps.hits.length || this.props.hits.length === this.props.total) {
					if (this.props.hits !== prevProps.hits) {
						// query has changed
		...
		if (prevProps.queryLog && this.props.queryLog && prevProps.queryLog !== this.props.queryLog) {
			...
			if (this.props.queryLog.from !== this.state.from) {
				...
				if (this.props.sortOptions) {
					...
					_options2.sort = [(_ref6 = {}, _ref6[this.props.sortOptions[0].dataField] = {
						order: this.props.sortOptions[0].sortBy
					}, _ref6)];
				} else if (this.props.sortBy) {
					var _ref7;
	...
	ReactiveList.prototype.render = function render() {
		...
		var results = allData.results,
		    streamResults = allData.streamResults;
		...
		return _react2.default.createElement(
			...
			!this.props.isLoading && !error && results.length === 0 && streamResults.length === 0 ? this.renderNoResults() : null,
			...
			this.props.renderAllData ? this.props.renderAllData(allData) : _react2.default.createElement(
				'div',
				{
				...
				[].concat(streamResults, filteredResults).map(function (item, index) {
					return renderData(item, function () {
