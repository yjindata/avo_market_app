...
var DataSearch = function (_Component) {
	...
	DataSearch.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
		...
		(0, _helper.checkSomePropChange)(this.props, prevProps, ['fieldWeights', 'fuzziness', 'queryFormat', 'dataField', 'nestedField'], function () {
			_this2.updateQuery(_this2.props.componentId, _this2.state.currentValue, _this2.props);
		});
	...
	DataSearch.prototype.render = function render() {
		...
		var _props2 = this.props,
		    ...
		    renderAllSuggestions = _props2.renderAllSuggestions;
			...
			this.props.defaultSuggestions || this.props.autosuggest ? _react2.default.createElement(_downshift2.default, _extends({
				...
				render: function render(_ref) {
					...
					return _react2.default.createElement(
						...
						_this3.renderLoader(),
						_this3.renderError(),
						!renderAllSuggestions && isOpen && suggestionsList.length ? _react2.default.createElement(
							'ul',
							{
...
var _initialiseProps = function _initialiseProps() {
	...
	this.onSuggestions = function (results) {
		var renderSuggestion = _this4.props.renderSuggestion;
	...
	this.updateQuery = function (componentId, value, props) {
		...
		props.setQueryOptions(_this4.props.componentId, _extends({}, _this4.queryOptions, customQueryOptions));
		props.updateQuery({
...
DataSearch.propTypes = {
	...
	renderSuggestion: _types2.default.func,
	renderAllSuggestions: _types2.default.func,
