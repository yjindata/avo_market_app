		...
		return _react2.default.createElement(_downshift2.default, {
			...
			render: function render(_ref) {
				...
				return _react2.default.createElement(
					...
					isOpen && itemsToRender.length ? _react2.default.createElement(
						'ul',
						{
						...
						dropdownItems.length ? dropdownItems.map(function (item, index) {
							...
							return _react2.default.createElement(
								...
								renderItem ? renderItem(item[labelField], item.doc_count, selected && _this2.props.multi) : _react2.default.createElement(
									'div',
									null,
